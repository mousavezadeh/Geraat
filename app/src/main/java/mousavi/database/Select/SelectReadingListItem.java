...
public class SelectReadingListItem extends BaseSqlSelect {
    String idlist;
    public SelectReadingListItem(SQLiteDatabase sqLiteDatabase,String idlist) {
    ...
    public String sql() {
        return "select name_moshtarek,radif_tashkhis,eshterak,address,CAST(meghdar_ghabli as int) meghdar_ghabli,SendToServer,EstateId, "
                ...
                " where   FKId_List=? " +
                " order by code_mamor,radif_tashkhis asc ";
    }

    @Override
    public String[] parameters() {
        return new String[]{this.idlist};
    }
}
