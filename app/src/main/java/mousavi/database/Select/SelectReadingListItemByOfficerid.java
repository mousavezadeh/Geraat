...
public class SelectReadingListItemByOfficerid extends BaseSqlSelect {
    String idlist;
    String officerid;
    public SelectReadingListItemByOfficerid(SQLiteDatabase sqLiteDatabase, String idlist,String officerid) {
