...
public class SelectReadingListItemByOfficeridRozkar extends BaseSqlSelect {
    String idlist;
    String officerid;
    String rozkar;
    public SelectReadingListItemByOfficeridRozkar(SQLiteDatabase sqLiteDatabase, String idlist, String officerid,String rozkar) {
    ...
    public String sql() {
        return "select name_moshtarek,radif_tashkhis,eshterak,address,CAST(meghdar_ghabli as int) meghdar_ghabli,SendToServer,EstateId, "
                ...
                " where FKId_List=? and code_mamor=? and cast(rozkar as int)=? order by code_mamor,radif_tashkhis asc ";

    }

    @Override
    public String[] parameters() {
        return new String[]{this.idlist,this.officerid,this.rozkar};
    }
}
